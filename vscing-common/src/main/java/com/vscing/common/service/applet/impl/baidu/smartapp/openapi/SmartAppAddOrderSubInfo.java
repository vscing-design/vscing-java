...
public class SmartAppAddOrderSubInfo {
    public static AddOrderSubInfoResponse addOrderSubInfo(AddOrderSubInfoRequest params)
        throws AddOrderSubInfoException {

        HttpClient client = HttpClient.newHttpClient();
        StringBuilder uriBuilder = new StringBuilder();
        uriBuilder.append("https://openapi.baidu.com");
        uriBuilder.append("/rest/2.0/smartapp/ordercenter/app/append/sub/info?");
        ...
        try {
            ...
            throw new AddOrderSubInfoException(e.toString());
        } catch (InterruptedException e) {
            throw new AddOrderSubInfoException(e.toString());
        }
        if (response.statusCode() != 200) {
            throw new AddOrderSubInfoException("StatusCode not 200!");
        }

        Gson gson = new Gson();
        AddOrderSubInfoResponse res =
            gson.<AddOrderSubInfoResponse>fromJson(response.body().toString(), AddOrderSubInfoResponse.class);
        return res;
    }
}
