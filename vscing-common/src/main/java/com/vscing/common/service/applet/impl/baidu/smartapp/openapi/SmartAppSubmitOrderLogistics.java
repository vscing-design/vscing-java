...
public class SmartAppSubmitOrderLogistics {
    public static SubmitOrderLogisticsResponse submitOrderLogistics(SubmitOrderLogisticsRequest params)
        throws SubmitOrderLogisticsException {

        HttpClient client = HttpClient.newHttpClient();
        StringBuilder uriBuilder = new StringBuilder();
        uriBuilder.append("https://openapi.baidu.com");
        uriBuilder.append("/rest/2.0/smartapp/ordercenter/app/add/main/logistics?");
        ...
        try {
            ...
            throw new SubmitOrderLogisticsException(e.toString());
        } catch (InterruptedException e) {
            throw new SubmitOrderLogisticsException(e.toString());
        }
        if (response.statusCode() != 200) {
            throw new SubmitOrderLogisticsException("StatusCode not 200!");
        }

        Gson gson = new Gson();
        SubmitOrderLogisticsResponse res =
            gson.<SubmitOrderLogisticsResponse>fromJson(response.body().toString(), SubmitOrderLogisticsResponse.class);
        return res;
    }
}
