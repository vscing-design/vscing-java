...
public class GetCouponResponsedatabaseInfo {
    ...
    private GetCouponResponsedatabaseInfodateInfo dateInfo;

    public GetCouponResponsedatabaseInfodateInfo getDateInfo() {
        return this.dateInfo;
    }

    public void setDateInfo(GetCouponResponsedatabaseInfodateInfo dateInfo) {
