...
public class SmartAppUpdateOrderInfo {
    public static UpdateOrderInfoResponse updateOrderInfo(UpdateOrderInfoRequest params)
        throws UpdateOrderInfoException {

        HttpClient client = HttpClient.newHttpClient();
        StringBuilder uriBuilder = new StringBuilder();
        uriBuilder.append("https://openapi.baidu.com");
        uriBuilder.append("/rest/2.0/smartapp/ordercenter/app/update/main/info?");
        ...
        try {
            ...
            throw new UpdateOrderInfoException(e.toString());
        } catch (InterruptedException e) {
            throw new UpdateOrderInfoException(e.toString());
        }
        if (response.statusCode() != 200) {
            throw new UpdateOrderInfoException("StatusCode not 200!");
        }

        Gson gson = new Gson();
        UpdateOrderInfoResponse res =
            gson.<UpdateOrderInfoResponse>fromJson(response.body().toString(), UpdateOrderInfoResponse.class);
        return res;
    }
}
