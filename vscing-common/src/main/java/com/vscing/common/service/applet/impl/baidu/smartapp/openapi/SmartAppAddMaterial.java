...
public class SmartAppAddMaterial {
    public static AddMaterialResponse addMaterial(AddMaterialRequest params) throws AddMaterialException {

        HttpClient client = HttpClient.newHttpClient();
        StringBuilder uriBuilder = new StringBuilder();
        uriBuilder.append("https://openapi.baidu.com");
        uriBuilder.append("/rest/2.0/smartapp/articlemount/material/add?");
        ...
        try {
            ...
            throw new AddMaterialException(e.toString());
        } catch (InterruptedException e) {
            throw new AddMaterialException(e.toString());
        }
        if (response.statusCode() != 200) {
            throw new AddMaterialException("StatusCode not 200!");
        }

        Gson gson = new Gson();
        AddMaterialResponse res =
            gson.<AddMaterialResponse>fromJson(response.body().toString(), AddMaterialResponse.class);
        return res;
    }
}
