...
public class SmartAppUpdateOrderSubStatus {
    public static UpdateOrderSubStatusResponse updateOrderSubStatus(UpdateOrderSubStatusRequest params)
        throws UpdateOrderSubStatusException {

        HttpClient client = HttpClient.newHttpClient();
        StringBuilder uriBuilder = new StringBuilder();
        uriBuilder.append("https://openapi.baidu.com");
        uriBuilder.append("/rest/2.0/smartapp/ordercenter/app/update/sub/status?");
        ...
        try {
            ...
            throw new UpdateOrderSubStatusException(e.toString());
        } catch (InterruptedException e) {
            throw new UpdateOrderSubStatusException(e.toString());
        }
        if (response.statusCode() != 200) {
            throw new UpdateOrderSubStatusException("StatusCode not 200!");
        }

        Gson gson = new Gson();
        UpdateOrderSubStatusResponse res =
            gson.<UpdateOrderSubStatusResponse>fromJson(response.body().toString(), UpdateOrderSubStatusResponse.class);
        return res;
    }
}
